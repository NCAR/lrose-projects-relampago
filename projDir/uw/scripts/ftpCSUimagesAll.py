...
prodNames_raw = ['variables',
                 ...
                 'z_kdp',
                 'z_kdp_cs']
prodNames = ['cappi_2km_6vars',
             'rain',
             'ppi_qc_level0_6vars',
             'ppi_qc_refl_allElevs',
             'ppi_qc_level0_refl_vel',
             'rhi_qc_refl_vel',
        ...
        for ftpFileName in ftpFileList:
            ...
            if (int(fileDateTimeStr) < int(startDateTimeStr)):
                ...
                if (localFileName not in localFileList):
                    ...
                    if imageTypes[idx] == 'raw_ppi' or \
                       imageTypes[idx] == 'self_consistency' or \
                       imageTypes[idx] == 'self_consistency_scatter':
